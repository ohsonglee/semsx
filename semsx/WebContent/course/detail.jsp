...
<div class="row"><input type="text" class="simple" name="title" value="<%=course.getTitle()%>" readonly="readonly"></div>
<div class="row"><textarea cols="10" rows="9" class="simple" name="description" readonly="readonly"><%=course.getDescription()%></textarea></div>
<div class="row"><input type="text" class="simple" name="hours" value="<%=course.getHours()%>" readonly="readonly"></div>
<div id="row6"><input type="button" id="btnCancel" value="Update"onclick="location.href='update.bit?no=<%=course.getNo()%>'"></div>
